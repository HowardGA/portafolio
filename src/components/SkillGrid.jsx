...
const skills = [
  { icon: <FaReact />, name: 'React', percentage: 70 },
  { icon: <FaHtml5 />, name: 'HTML5', percentage: 90 },
  { icon: <FaCss3Alt />, name: 'CSS3', percentage: 70 },
  { icon: <FaJsSquare />, name: 'JavaScript', percentage: 80 },
  { icon: <SiTailwindcss />, name: 'Tailwind CSS', percentage: 70 },
  { icon: <FaNodeJs />, name: 'Node.js', percentage: 70 },
  { icon: <FaPython />, name: 'Python', percentage: 55 },
